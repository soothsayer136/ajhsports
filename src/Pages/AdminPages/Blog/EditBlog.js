...
function EditBlog() {
    ...
    const getBlog = async (values, actions) => {
        try {
            ...
            if (result.data.success) {
                ...
                setContentData(result?.data?.data?.content)
    ...
    const editBlogDetail = async (values, actions) => {
        try {
            ...
            let result = await axios.put('/blog/' + blogId, formData)
            if (result.data.success) {
    ...
    return (
        <div className='max-w-7xl mx-auto'>
            ...
            <div className='mt-4 p-8  mx-auto border rounded  bg-white'>
                <div className='mb-5'>
                    <h1 className="text-4xl font-bold tracking-tight text-gray-900">Edit Blog</h1>
                </div>
                                    ...
                                    {blogData?.image && (
                                        <div className='relative border '>
                                            ...
                                            <img
                                                ...
                                                src={`${process.env.REACT_APP_IMG_URI}${blogData?.image}`}
                                            />
                                        </div>
                                    )}
                                </div>
