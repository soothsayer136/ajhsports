    ...
    return (
        <div className='mx-auto max-w-7xl px-4'>

            {
                ...
                <AddEvent closeModal={closeAddModal} modalIsOpen={isAddModalOpen}
            ...
            <div className="flex items-baseline justify-between  pb-6 pt-5">
                ...
                <button onClick={() => {
                    openAddModal()
                }} className='bg-blue-800 p-3 rounded-md text-white font-semibold px-4'>Add Event</button>
            </div>
            <div>
                    ...
                    <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                        <div className='text-sm text-gray-700'>
                            <p className="font-semibold">
                                {totalEventCount} Total Results
                            </p>
                        </div>
                        <div className='flex flex-wrap items-center gap-3'>
                            <label>Showing</label>
                            <select defaultValue={eventPageSize} className='border rounded py-1' onChange={(e) => {
                                setCurrentEventPage(1)
